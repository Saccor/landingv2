  ...
  return (
    <>
      <header className="w-full h-[51px] lg:h-20 bg-black relative z-50">
        {/* Mobile: Full width centered logo with hamburger */}
        <div className="lg:hidden absolute inset-0 flex items-center justify-between px-4">
          ...
          {/* Logo */}
          <Link href="/" className="relative flex items-center justify-center flex-shrink-0">
            <svg width="78" height="28" viewBox="0 0 78 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-auto h-6">
