  ...
  return (
    <>
      <header className="w-full h-[51px] lg:h-20 bg-black relative z-50">
        {/* Mobile: Hamburger on right only */}
        <div className="lg:hidden absolute inset-0 flex items-center justify-end px-4">
        ...
        {/* Desktop: Constrained container layout */}
        <div className="hidden lg:flex max-w-[1440px] mx-auto px-4 lg:px-32 h-full items-center justify-between">
          ...
          <div className="flex justify-center items-center w-1/3 h-full">
            <Link href="/" className="relative w-full h-full lg:w-28 lg:h-10 flex items-center justify-center flex-shrink-0">
              {/* Mobile Logo - Show on screens smaller than 1024px */}
              <svg width="78" height="28" viewBox="0 0 78 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="block lg:hidden w-auto h-6">
                ...
                <path d="M77.9813 16.8116C77.9813 14.9786 77.5964 13.3638 76.8256 11.9672C76.0547 10.5468 74.9777 9.44776 73.5955 8.66881C72.2134 7.88986 70.6376 7.50098 68.8695 7.50098C67.1013 7.50098 65.4012 7.90172 63.9734 8.70319C62.5677 9.50467 61.4684 10.65 60.6752 12.1391C59.9044 13.6057 59.5195 15.3118 59.5195 17.2586C59.5195 19.2054 59.9161 20.9233 60.7093 22.4125C61.5259 23.8779 62.6358 25.0244 64.0414 25.8484C65.4693 26.6498 67.0791 27.0506 68.8695 27.0506C71.0682 27.0506 72.9045 26.5005 74.3781 25.4014C75.8741 24.2786 76.9054 22.8476 77.4721 21.1059H73.2893C72.4281 22.8701 70.9544 23.7522 68.8683 23.7522C67.4181 23.7522 66.1932 23.2946 65.1959 22.3781C64.1986 21.4616 63.6437 20.2475 63.5298 18.7359H77.8452C77.9355 18.1632 77.9813 17.5218 77.9813 16.8116ZM63.5639 15.575C63.7457 14.1084 64.3124 12.9524 65.264 12.1047C66.2155 11.2345 67.3606 10.7994 68.6982 10.7994C70.1718 10.7994 71.4073 11.2345 72.4046 12.1047C73.4019 12.975 73.9123 14.1321 73.9346 15.575H63.5639Z" fill="white"/>
              ...
              {/* Desktop Logo - Show on screens 1024px and larger */}
              <Image
                src="/logo.svg"
                alt="Logo"
                width={120}
      ...
      {/* Mobile Menu Panel */}
      <div
        className={`lg:hidden fixed top-0 left-0 h-full w-80 max-w-[85vw] bg-black z-50 transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <nav className="p-4">
          <div className="space-y-2">
            <Link
              href="/survey"
              className="flex items-center px-4 py-3 text-white text-lg font-medium hover:bg-gray-800 rounded-lg transition-colors"
              onClick={closeMenu}
            >
