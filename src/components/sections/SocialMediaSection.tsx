  ...
  return (
    <RevealSection className={`bg-black text-white py-8 ${className}`}>
      <div className="w-full flex justify-center">
        <div className="w-[353px] lg:w-[1400px] px-0 py-0 flex flex-col items-center gap-6">
          <h2 className="w-full max-w-[305px] lg:max-w-none text-2xl font-bold text-center">Follow Us</h2>
          
          {/* Desktop layout for lg+ (1400px+) */}
