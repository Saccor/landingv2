...
export default function FeatureSection() {
  return (
    <RevealSection className="bg-black overflow-hidden">
      <div className="w-full flex flex-col items-center responsive-container responsive-section px-4 pt-0 pb-8">
        <div className="w-full flex justify-center">
          {/* Gray box: responsive alignment with padding/content containers */}
          <div className="bg-[var(--Gray-900,#1b1b1b)] shadow-lg responsive-content w-[353px] lg:w-[1400px] lg:h-[587px] flex flex-col items-start px-6 py-7 lg:px-16 lg:py-0 lg:justify-center">
            {/* Heading inside the gray box, responsive text sizing */}
            <h2 className="font-montserrat font-bold responsive-text text-[24px] leading-[32px] bg-gradient-to-r from-white to-[#C8A596] bg-clip-text text-transparent text-left mb-[50px] lg:text-[28px] lg:leading-[36px] w-full max-w-[305px] lg:max-w-none">
            ...
            {/* Features grid with responsive gaps */}
            <div className="w-full max-w-[305px] lg:max-w-none grid grid-cols-1 responsive-gap gap-6 lg:grid-cols-2 lg:grid-rows-3 lg:gap-x-16 lg:gap-y-8">
              {/* Feature 1: Studio-Grade Sound */}
              <div className="flex flex-col responsive-gap gap-2 lg:gap-3">
                <div className="flex flex-row items-center gap-3 lg:gap-4">
                  <SoundwaveIcon className="w-[39px] h-[25px]" />
                  <span className="font-montserrat font-semibold text-white responsive-text text-xl">Studio-Grade Sound</span>
                </div>
                <p className="font-montserrat font-medium responsive-text text-[14px] leading-[20px] text-white">
              ...
              <div className="flex flex-col responsive-gap gap-2 lg:gap-3">
                <div className="flex flex-row items-center gap-3 lg:gap-4">
                  ...
                  <span className="font-montserrat font-semibold text-white responsive-text text-xl">Modular Power</span>
                </div>
                <p className="font-montserrat font-medium responsive-text text-[14px] leading-[20px] text-white">
              ...
              <div className="flex flex-col responsive-gap gap-2 lg:gap-3">
                <div className="flex flex-row items-center gap-3 lg:gap-4">
                  ...
                  <span className="font-montserrat font-semibold text-white responsive-text text-xl">Hybrid ANC</span>
                </div>
                <p className="font-montserrat font-medium responsive-text text-[14px] leading-[20px] text-white">
              ...
              <div className="flex flex-col responsive-gap gap-2 lg:gap-3">
                <div className="flex flex-row items-center gap-3 lg:gap-4">
                  ...
                  <span className="font-montserrat font-semibold text-white responsive-text text-xl">Low latency mode</span>
                </div>
                <p className="font-montserrat font-medium responsive-text text-[14px] leading-[20px] text-white">
              ...
              <div className="flex flex-col responsive-gap gap-2 lg:gap-3">
                <div className="flex flex-row items-center gap-3 lg:gap-4">
                  ...
                  <span className="font-montserrat font-semibold text-white responsive-text text-xl">IPX54 rated</span>
                </div>
                <p className="font-montserrat font-medium responsive-text text-[14px] leading-[20px] text-white">
              ...
              <div className="flex flex-col responsive-gap gap-2 lg:gap-3">
                <div className="flex flex-row items-center gap-3 lg:gap-4">
                  ...
                  <span className="font-montserrat font-semibold text-white responsive-text text-xl">Recycled materials</span>
                </div>
                <p className="font-montserrat font-medium responsive-text text-[14px] leading-[20px] text-white">
