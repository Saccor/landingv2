...
/**
 * Props for the CookieSettingsModal component
 */
...
const COOKIE_CATEGORIES: CookieCategory[] = [
  ...
  },
  {
    ...
    description: 'Help us understand visitor behavior to improve our website.',
    required: false,
  },
  {
    key: 'marketing',
    title: 'Marketing Cookies',
    description: 'Used for targeted advertising and social media integration.',
    required: false,
  },
];
...
export default function CookieConsent() {
  ...
  /**
   * Save custom consent settings and close modals
   */
...
/**
 * Consent action buttons for the banner
 */
...
/**
 * Detailed cookie preferences modal with granular controls
 */
function CookieSettingsModal({ onSave, onClose }: CookieSettingsModalProps) {
  ...
  /**
   * Accept all cookies in modal
   */
  const handleAcceptAllInModal = () => {
    setSettings(ALL_ACCEPTED_SETTINGS);
    onSave(ALL_ACCEPTED_SETTINGS);
  };
...
/**
 * Essential cookies card (always enabled)
 */
...
/**
 * Optional cookie category card with toggle
 */
function OptionalCookieCard({
  category,
  isEnabled,
  onToggle,
}: {
